...
export const Users = ({ onClickSendInvites, items, isLoading, searchValue, onSetSearchValue, invites, onClickInvite }) => {
  return (
    <>
      <div className="search">
        ...
        <input value={searchValue} onChange={onSetSearchValue} type="text" placeholder="Найти пользователя..." />
      </div>
      {isLoading ? (
